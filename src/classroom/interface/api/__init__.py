...
from src.classroom.interface.api.progress_controller import router as progress_router

__all__ = ["courses_router", "lessons_router", "modules_router", "progress_router"]
