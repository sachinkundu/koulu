...
class CourseLevelRequirementModel(Base):
    """Stores minimum level requirements for courses."""

    __tablename__ = "course_level_requirements"
    ...
    __table_args__ = (
        UniqueConstraint("community_id", "course_id", name="uq_course_level_req_community_course"),
    )
