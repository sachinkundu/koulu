...
**Should Have:**
- ✅ Leaderboards and gamification (Points & Levels: ✅ Complete — 40/40 scenarios, 6 E2E tests; Leaderboard rankings: ✅ Complete — 3 panels, sidebar widget, profile card, 7 E2E tests)
- ❌ Calendar and events
- ❌ Direct messaging
...
| Leaderboards | `docs/features/gamification/leaderboards-prd.md` | `tests/features/gamification/leaderboards.feature` | ✅ Complete (3 ranking panels, sidebar widget, profile card, 7 E2E tests) |
