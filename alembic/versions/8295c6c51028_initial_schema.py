...
def upgrade() -> None:
    ...
    op.create_index('idx_category_community_name', 'categories', ['community_id', 'name'], unique=True)
    op.create_index(op.f('ix_categories_community_id'), 'categories', ['community_id'], unique=False)
    ...
    op.create_index('idx_reaction_user_target', 'reactions', ['user_id', 'target_type', 'target_id'], unique=True)
    ...
    op.create_index('idx_post_category_created', 'posts', ['category_id', 'created_at'], unique=False)
    op.create_index('idx_post_community_created', 'posts', ['community_id', 'created_at'], unique=False)
    op.create_index('idx_post_community_pinned', 'posts', ['community_id', 'is_pinned'], unique=False)
